          ...
          <div className="flex flex-col items-center space-y-4 animate-fade-in-up delay-200">
            {callStatus === "not-started" && (
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={testSessionSummary}
                  className="bg-slate-800 hover:bg-slate-700 text-slate-300 px-6 py-4 rounded-full text-lg font-medium shadow-lg transition-all duration-300 hover:scale-105 border border-slate-700/50 hover:border-slate-600/50"
                >
                  Test Summary
                </button>
              </div>
